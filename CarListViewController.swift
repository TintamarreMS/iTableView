//
//  CarListViewControllerTableViewController.swift
//  iTableView
//
...
class CarListViewController: UITableViewController {
    ...
    @IBAction func doneAdd(segue:UIStoryboardSegue) {
        ...
        //        println(carDetailVC.vbrandModel)
        let newCar = Car.createInManagedObjectContext(managedObjectContext!,vBrandModel: carDetailVC.vBrand,vDescription: carDetailVC.vDescription)
        cars.append(newCar)
    ...
    func fetchCars() {
        ...
        if let fetchResults = managedObjectContext!.executeFetchRequest(fetchRequest, error: nil) as? [Car] {
            cars = fetchResults
        }
    }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.textLabel!.text = cars[indexPath.row].carBrandModel
        cell.detailTextLabel!.text = cars[indexPath.row].carDescription
        return cell
    }
